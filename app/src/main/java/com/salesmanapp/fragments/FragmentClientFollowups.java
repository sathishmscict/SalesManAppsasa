...
public class FragmentClientFollowups extends android.support.v4.app.Fragment {
    ...
    public FragmentClientFollowups() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_followup_data, container,
                false);
